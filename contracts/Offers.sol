...
contract OffersAccessControl {
    ...
    function withdrawTotalLostAndFoundBalance() external onlyLostAndFound {
        ...
        payable(lostAndFoundAddress).transfer(balance);
    }
...
contract Offers is OffersBase {
    ...
    bytes4 constant InterfaceSignature_ERC721_ = bytes4(0x9a20483d);

    // Reference to contract tracking NFT ownership
    ERC721_ public nonFungibleContract;
    ...
    constructor(
      ...
      uint256 _offerCut
        ...
        ERC721_ candidateContract = ERC721_(_nftAddress);
        //require(candidateContract.supportsInterface(InterfaceSignature_ERC721_), "NFT Contract needs to support ERC721_ Interface");
    ...
    function fulfillOffer(uint256 _tokenId, uint128 _minOfferPrice) external whenNotFrozen {
        ...
        require(offerPrice >= _minOfferPrice, "cannot fulfill offer 2 offer price too low");
    ...
    function batchRemoveExpired(uint256[] memory _tokenIds) external whenNotFrozen {
